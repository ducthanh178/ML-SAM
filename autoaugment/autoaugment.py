...
import dataclasses
from sam_new.autoaugment import policies as optimal_policies
import tensorflow.compat.v1 as tf
try:
  from tensorflow_addons import image as contrib_image
except ImportError:
  # Fallback to mock if tensorflow_addons is not available
  import sys
  import os
  sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
  from sam_new import tensorflow_addons_mock
  contrib_image = tensorflow_addons_mock.image
